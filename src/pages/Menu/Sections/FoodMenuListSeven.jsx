const FoodMenuListSeven = () => {
    ...
    const menuItems = [
      ...
      },
      {
        ...
        name: "Apple Juice",
        description:
          "Pure and crisp apple juice, offering a naturally sweet and refreshing option for all ages.",
          image: "../images/food-img/dummy.jpg",
          price:4,
      },
      {
    ...
    // juice
    const juiceMenuItems = [
      {
        name: "Orange Juice",
        description: "Freshly squeezed orange juice, bursting with citrusy sweetness, perfect for a refreshing start to your meal.",
            image: "../images/food-img/dummy.jpg", 
            price:4,
      },
      {
        name: "Ginger Beer",
        description: "A zesty, non-alcoholic ginger beer with a spicy kick, offering a bold and invigorating taste.",
        image: "../images/food-img/dummy.jpg",
          price:4.5,
      },
      {
        name: "Hibiscus Juice (Sobolo)",
        description: "A vibrant West African hibiscus drink, lightly sweetened with a hint of ginger, known for its tangy and refreshing flavor.",
        image: "../images/food-img/dummy.jpg",
          price:4.5,
      },
      {
        name: "Pineapple Juice",
        description: "Sweet and tropical pineapple juice, freshly made to bring a taste of the tropics to your table.",
        image: "../images/food-img/dummy.jpg",
          price:4,
      },
