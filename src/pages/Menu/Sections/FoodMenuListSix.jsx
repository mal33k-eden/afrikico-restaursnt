  ...
  const specialsMenuItems = [
    {
      ...
      description:
        "A rich, earthy soup made from palm nut extract, slow-cooked with meats and spices — served with soft, smooth rice balls to soak up every drop.",
    ...
    },
    {
      ...
      description:
        "Creamy and spicy groundnut soup paired with kokonte (dried cassava dough), delivering deep flavor and a truly traditional experience.",
    ...
    },
    {
      name: "Tuo Zaafi (TZ)",
      description:
        "A staple from northern Ghana, TZ is served with a savory green soup and ayoyo (jute leaves), offering a perfect balance of texture and nutrition.",
    ...
    },
    {
      ...
      description:
        "Smooth, tangy banku paired with flavorful crabs in a rich, peppery sauce — a dish full of bold coastal flair.",
      image: "../images/food-img/dummy.jpg",
      price: 28,
    },
    {
      ...
      description:
        "A traditional Ghanaian delicacy made from roasted corn powder cooked in palm nut soup",
      image: "../images/food-img/dummy.jpg",
      price: 25,
    },
    */
