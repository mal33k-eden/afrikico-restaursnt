const FoodMenuListTwo = () => {
  ...
  const sideMenuItems = [
    ...
    },
    {
      name: "Fried Yam",
      description:
        "Thick-cut yam pieces fried until crispy on the outside and tender inside. Perfect for dipping or enjoyed on their own.",
      image: "../images/food-img/dummy.jpg",
      price: 10,
    },
    {
    ...
    },
    {
      ...
      description:
        "A beloved West African dish made with fragrant rice simmered in a rich tomato-based sauce with spices. Flavorful, vibrant, and unforgettable.",
    ...
    },
    {
      name: "Kenkey",
      description:
        "A traditional fermented corn dough dish from Ghana, steamed in corn husks for a slightly tangy flavor — perfect with pepper sauce and fried fish.",
      image: "../images/food-img/dummy.jpg",
      price: 4,
    },
    {
      name: "White Rice",
      description:
        "Fluffy, steamed white rice — a simple and versatile companion to any main dish.",
      image: "../images/food-img/dummy.jpg",
      price: 5,
    },
    {
      name: "Banku",
      description:
        "A fermented mix of corn and cassava dough, cooked into a smooth, stretchy texture. Typically served with soup, stew, or grilled protein.",
      image: "../images/food-img/dummy.jpg",
      price: 5,
    },
    {
      name: "Omo Tuo",
      description:
        "Soft rice balls made from mashed white rice, traditionally served with rich, hearty soups like groundnut or palm nut soup.",
      image: "../images/food-img/dummy.jpg",
      price: 6,
    },
    {
      name: "Waakye",
      description:
        "A popular Ghanaian dish made from rice and black-eyed beans, often cooked with millet leaves for its signature color and aroma.",
      image: "../images/food-img/dummy.jpg",
      price: 10,
    },
    {
    ...
    },
    {
      name: "Pounded Yam",
      description:
        "A West African dish made by boiling and pounding yam until it becomes smooth and doughy. Enjoyed with stews like Egusi.",
      image: "../images/food-img/dummy.jpg",
      price: 8,
    },
  ];
