const FoodMenuListFive = () => {
    ...
    const lunchMenuItems = [
      ...
      {
        name: "Pig Feet Stew",
        description: "Slow-cooked delicacy made with tender pig feet simmered in a deeply seasoned, tomatoe sauce Infused with herbs, spices, and a hint of heat.  Served with white rice.",
          image: "../images/food-img/dummy.jpg", 
          price:15,
      },
      {
        name: "Beans Stew with Fried Plantain(Red Red)",
        description: "Black Eyed peas cooked in palm  oil served with fish ( Salmon)  and fried plantain.",
          image: "../images/food-img/dummy.jpg",
          price:15,
      },
